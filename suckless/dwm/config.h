...
static const char *bt[]  = { "xfce4-power-manager-settings", NULL };
static const char *dd[]  = { "app", NULL };
...
static Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,      Button1,        spawn,          {.v = pv } },
	{ ClkStatusText,        0,              Button3,        spawn,          {.v = bt } },
	{ ClkStatusText,        0,              Button1,        spawn,          {.v = dd } },
